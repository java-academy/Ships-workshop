...
Warsztat dostępny https://github.com/java-academy/Ships-workshop/blob/master/_docs/Angular.adoc[tutaj]

=== Spring-Boot

Warsztat dostępny https://github.com/java-academy/Spring-workshop/blob/workshop/warsztaty_instrukcja.adoc[tutaj]
...
+
----
git clone https://github.com/java-academy/Ships-workshop.git
git clone https://github.com/java-academy/Ships-workshop-backend.git
----
+
